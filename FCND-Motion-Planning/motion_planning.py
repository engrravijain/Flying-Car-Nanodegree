...
class MotionPlanning(Drone):
    ...
    def __init__(self, connection, goal_global_position=None):
        ...
        if goal_global_position is None:
            goal_global_position = [-122.40195876, 37.79673913, -0.147]
    ...
    def plan_path(self):
        ...
        positions = open('colliders.csv').readline()
        lat, lon = positions.replace(' ', '').replace('lat0', '').replace('lon0', '').split(',')
